...
Например: python notes.py add --title "новая заметка" –msg "тело новой заметки"
...
Критерии оценки:
Приложение должно запускаться без ошибок, должно уметь сохранять данные в файл, уметь читать данные из файла, делать выборку по дате, 
